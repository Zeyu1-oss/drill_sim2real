...
class Visualizer:
    ...
    def save_visualization_to_file(self, pointcloud, file_path, color:tuple=None):
        ...
        fig.update_layout(
            scene=dict(
                aspectmode='cube',
                xaxis=dict(range=[-1, 1], showbackground=False, showgrid=True,
                           showline=True, linecolor='grey', zerolinecolor='grey',
                           zeroline=False, gridcolor='grey'),
                yaxis=dict(range=[-1, 1], showbackground=False, showgrid=True,
                           showline=True, linecolor='grey', zerolinecolor='grey',
                           zeroline=False, gridcolor='grey'),
                zaxis=dict(range=[-1, 1], showbackground=False, showgrid=True,
                           showline=True, linecolor='grey', zerolinecolor='grey',
                           zeroline=False, gridcolor='grey'),
                bgcolor='white'
            )
